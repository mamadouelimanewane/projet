    ...
    <div className="space-y-6 animate-entrance flex flex-col h-[calc(100vh-160px)]">
      ...
      <div className="flex-1 glass-card rounded-2xl overflow-hidden relative border border-indigo-500/20 shadow-[0_0_50px_rgba(99,102,241,0.05)]">
        <div className="absolute top-6 left-6 z-10 space-y-2">
          <div className="flex items-center gap-2 bg-slate-900/80 p-2 px-3 border border-slate-700 rounded-lg text-[10px] text-white backdrop-blur">
        ...
        <div className="absolute right-6 bottom-6 bg-slate-900/60 p-4 border border-slate-700 rounded-xl text-[10px] text-slate-400 max-w-[200px]">
