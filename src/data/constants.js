...
export const MODULES = [
  ...
  { isHeader: true, label: "Planification & Exécution" },
  ...
  { isHeader: true, label: "Suivi, Finance & Risques" },
  ...
  { isHeader: true, label: "Intelligence & IA" },
  ...
  { isHeader: true, label: "Outils Avancés & Modèles" },
  ...
  { isHeader: true, label: "Collaboration & Documents" },
  ...
  { isHeader: true, label: "Automatisation & Webhooks" },
  ...
  { isHeader: true, label: "Gouvernance, ESG & Conformité" },
  ...
  { isHeader: true, label: "Secteurs d'Activité" },
  ...
  { isHeader: true, label: "Système & Autre" },
