export const INITIAL_DATA = {
  ...
  jalons: [
    { id: 1, projet: "Refonte SI Comptable", jalon: "Kick-off projet", date: "2026-01-15", responsable: "Jean D.", statut: "Atteint", notes: "Réunion de lancement réussie" },
    { id: 2, projet: "Refonte SI Comptable", jalon: "Validation specs", date: "2026-02-28", responsable: "Marie C.", statut: "Atteint", notes: "Specs validées par le client" },
    { id: 3, projet: "App Mobile RH", jalon: "Livraison MVP", date: "2026-04-15", responsable: "Paul M.", statut: "En cours", notes: "En développement" },
    { id: 4, projet: "Migration Cloud", jalon: "Tests UAT", date: "2026-05-15", responsable: "Sophie L.", statut: "Planifié", notes: "À planifier avec client" },
    { id: 5, projet: "Portail Client", jalon: "Mise en production", date: "2026-06-30", responsable: "Jean D.", statut: "Planifié", notes: "Date cible finale" },
  ],
  problemes: [
    { id: 1, projet: "Refonte SI Comptable", description: "Bug critique dans le module de facturation", priorite: "Critique", statut: "En cours", responsable: "Paul M.", dateSignalement: "2026-02-10", resolution: "" },
    { id: 2, projet: "Refonte SI Comptable", description: "Performance dégradée sur les rapports", priorite: "Haute", statut: "Résolu", responsable: "Marie C.", dateSignalement: "2026-01-25", resolution: "Optimisation des requêtes SQL" },
    { id: 3, projet: "App Mobile RH", description: "Problème d'authentification SSO", priorite: "Haute", statut: "En cours", responsable: "Jean D.", dateSignalement: "2026-02-18", resolution: "" },
    { id: 4, projet: "Migration Cloud", description: "Interface non responsive sur mobile", priorite: "Moyenne", statut: "À faire", responsable: "Sophie L.", dateSignalement: "2026-02-20", resolution: "" },
    { id: 5, projet: "Portail Client", description: "Exports CSV incorrects", priorite: "Basse", statut: "Résolu", responsable: "Paul M.", dateSignalement: "2026-01-30", resolution: "Correction format encodage" },
  ],
  risques: [
    { id: 1, projet: "Refonte SI Comptable", risque: "Départ d'un membre clé", gravite: 5, probabilite: 2, attenuation: "Plan de succession, documentation", statut: "Actif" },
    { id: 2, projet: "Refonte SI Comptable", risque: "Dépassement budgétaire", gravite: 4, probabilite: 3, attenuation: "Suivi hebdomadaire des coûts", statut: "Actif" },
    { id: 3, projet: "App Mobile RH", risque: "Changement des exigences", gravite: 4, probabilite: 4, attenuation: "Processus de gestion des changements", statut: "Actif" },
    { id: 4, projet: "Migration Cloud", risque: "Retard fournisseur", gravite: 3, probabilite: 2, attenuation: "Contrats avec pénalités", statut: "Atténué" },
    { id: 5, projet: "Portail Client", risque: "Faille de sécurité", gravite: 5, probabilite: 1, attenuation: "Audits de sécurité réguliers", statut: "Actif" },
    { id: 6, projet: "Infrastructure Global", risque: "Indisponibilité infrastructure", gravite: 4, probabilite: 2, attenuation: "Plan de reprise d'activité", statut: "Atténué" },
  ],
  delais: [
