  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
           ...
           <div className="relative mt-2">
              ...
              {isCountryDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-48 app-surface border app-border rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
        ...
        <div className="flex gap-2 app-surface p-1 rounded-xl border app-border">
           {["budget", "projets", "impact"].map(tab => (
             <button 
               key={tab}
               onClick={() => setActiveTab(tab)}
               className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-indigo-600 text-white shadow-lg' : 'app-text3 hover:app-text'}`}
             >
               {tab}
             </button>
           ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 p-6 glass-card app-border">
           {activeTab === 'budget' && (
             <div className="space-y-6">
                ...
                <div className="space-y-3 pt-4">
                   <p className="text-[10px] font-black app-text3 uppercase tracking-widest">Suivi Inter-Structurel ({currentConfig.currency})</p>
                   <div className="overflow-x-auto">
                      <table className="w-full text-left">
                         <thead>
                            <tr className="text-[9px] font-black app-text3 uppercase border-b app-border">
           ...
           {activeTab !== 'budget' && (
              <div className="flex items-center justify-center h-full app-text3 text-xs italic">
        ...
        <div className="space-y-6">
           <Card className="p-6 glass-card app-border bg-gradient-to-br from-indigo-900/20 to-slate-900">
              ...
              <div className="space-y-4">
                 {[
                   ...
                   <div key={i} className="flex items-center justify-between p-3 app-surface border app-border rounded-xl">
           ...
           <Card className="p-6 glass-card app-border">
              <h4 className="text-[10px] font-black uppercase tracking-widest app-text3 mb-4">Impact par Région ({selectedCountry})</h4>
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                 {regionalImpact.map((item, i) => (
                    <div key={i} className="flex items-center gap-1.5">
                       ...
                       <span className="text-[8px] font-bold app-text3 uppercase">{item.name}</span>
                    </div>
                 ))}
              </div>
           </Card>
