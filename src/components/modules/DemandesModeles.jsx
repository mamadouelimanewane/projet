      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 app-surface2 border app-border rounded-xl overflow-hidden shadow-xl">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b app-border text-left text-xs font-bold app-text2 uppercase">
        ...
        <div className="app-surface2 border app-border rounded-xl p-5 shadow-xl flex flex-col">
          <h3 className="text-sm font-bold app-text mb-4 uppercase tracking-wider flex items-center gap-2"><span className="text-indigo-400">📋</span> Centre de Modèles (Blueprints)</h3>
          <p className="text-xs app-text2 mb-4">Standardisez l'exécution : transformez une demande approuvée en projet grâce à un modèle PMO préconfiguré.</p>
