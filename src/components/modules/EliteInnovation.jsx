    ...
    <div className="space-y-6 animate-entrance max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-entrance">
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex justify-center py-4 relative">
                ...
                <div className="w-full max-w-[500px] aspect-square relative perspective-1000">
                  ...
                  <div className="absolute top-0 right-0 p-4 glass-card rounded-xl border border-white/5 animate-float">
                    <p className="text-[10px] text-slate-500 uppercase font-black">Score de Résilience</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 bg-gradient-to-br from-indigo-900/20 to-slate-900 border-indigo-500/20">
                ...
                <p className="text-xs text-slate-400 mb-4">Visualisation temps-réel de l'avancement physique du chantier (Star Academy).</p>
                <div className="h-32 bg-slate-800/50 rounded-xl border border-slate-700 flex items-center justify-center overflow-hidden relative">
              ...
              <Card className="p-6 bg-gradient-to-br from-purple-900/20 to-slate-900 border-purple-500/20">
                ...
                <p className="text-xs text-slate-400 mb-4">Optimisation automatique de l'allocation des ressources via moteur IA.</p>
                <div className="space-y-2">
                   <div className="flex justify-between text-[10px] text-slate-500 font-bold uppercase"><span>RH</span><span>92%</span></div>
                   <div className="h-1.5 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-purple-500 w-[92%]"></div></div>
                   <div className="flex justify-between text-[10px] text-slate-500 font-bold uppercase mt-2"><span>Matériel</span><span>65%</span></div>
                   <div className="h-1.5 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-indigo-500 w-[65%]"></div></div>
                </div>
              </Card>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <Card className="p-6 border-slate-800">
              <h3 className="text-xs font-black text-slate-500 uppercase tracking-widest mb-6">Alertes Stratégiques</h3>
      ...
      {tab === "trust" && (
        <div className="space-y-8 animate-entrance max-w-4xl mx-auto">
          <Card className="p-10 text-center bg-gradient-to-br from-slate-900 to-slate-950 border-2 border-slate-800 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500 to-transparent"></div>
            
            {!certified ? (
              <>
                <div className="w-24 h-24 rounded-full bg-slate-800 flex items-center justify-center mx-auto mb-6 shadow-2xl border border-white/10">
              ...
              <div className="animate-entrance">
                ...
                <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                  <div className="p-4 bg-slate-800/40 rounded-xl border border-white/5">
                    <p className="text-[10px] text-slate-500 font-black uppercase mb-1">Preuve de Travail</p>
                    <p className="text-xs text-slate-300">PMBOK Compliance: 98%</p>
                  </div>
                  <div className="p-4 bg-slate-800/40 rounded-xl border border-white/5">
                    <p className="text-[10px] text-slate-500 font-black uppercase mb-1">Preuve d'Enjeu</p>
                    <p className="text-xs text-slate-300">Budget Audité: 1.2B FCFA</p>
                  </div>
                  <div className="p-4 bg-slate-800/40 rounded-xl border border-white/5">
                    <p className="text-[10px] text-slate-500 font-black uppercase mb-1">Digital Identity</p>
                    <p className="text-xs text-slate-300">Signé par M. Wane</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="space-y-4">
             <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest px-2">Registre des Événements Certifiés (Blockchain Log)</p>
             {BLOCKCHAIN_LOGS.map((log, i) => (
               <div key={i} className="flex items-center gap-4 p-4 glass-card rounded-xl border border-white/5 hover:border-indigo-500/30 transition-all">
                 <div className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center text-[10px] font-mono text-indigo-400 border border-slate-700">{log.id}</div>
        ...
        <div className="space-y-6 animate-entrance">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8">
              ...
              <p className="text-sm text-slate-400 mb-6">Calcul de la probabilité de réussite sur 10 000 itérations aléatoires.</p>
              ...
              <div className="mt-4 flex justify-between items-end">
                <div>
                  <p className="text-[10px] text-slate-500 font-black uppercase">Probabilité Succès</p>
                  <p className="text-3xl font-black text-indigo-400">82%</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] text-slate-500 font-black uppercase">Écart-Type</p>
                  <p className="text-lg font-black text-slate-300">+/- 12 jours</p>
                </div>
              </div>
            </Card>
            ...
            <div className="space-y-6">
              <Card className="p-6 border-indigo-500/20 bg-indigo-500/5">
                ...
                <div className="space-y-3">
                  <button className="w-full text-left p-3 rounded-lg bg-slate-800 border border-slate-700 hover:border-indigo-500 transition-all">
                    <p className="text-xs font-bold text-white">1. Fast-Tracking (Parallélisation)</p>
                    <p className="text-[10px] text-slate-500">Gain estimé : 18 jours · Risque Qualité : +15%</p>
                  </button>
                  <button className="w-full text-left p-3 rounded-lg bg-slate-800 border border-slate-700 hover:border-indigo-500 transition-all">
                    <p className="text-xs font-bold text-white">2. Crashing (Injection Ressources)</p>
                    <p className="text-[10px] text-slate-500">Gain estimé : 25 jours · Coût additionnel : 14M FCFA</p>
                  </button>
                  <button className="w-full text-left p-3 rounded-lg bg-slate-800 border border-slate-700 hover:border-indigo-500 transition-all">
                    <p className="text-xs font-bold text-white">3. Scénario Pessimiste (Risque Max)</p>
                    <p className="text-[10px] text-slate-500">Retard estimé : 40 jours · Budget : +22%</p>
                  </button>
                </div>
              </Card>
