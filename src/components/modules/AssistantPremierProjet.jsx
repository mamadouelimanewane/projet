    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] animate-entrance">
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="relative inline-block mb-4">
          ...
          <div className="relative w-24 h-24 bg-slate-900 border-2 border-indigo-500/30 rounded-3xl flex items-center justify-center shadow-2xl shadow-indigo-500/20 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          <Card className="p-6 glass-card rounded-2xl border border-slate-700/50 hover:border-slate-600 transition-all text-left cursor-pointer group" onClick={() => navigate('/onboarding')}>
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center">
                <BookOpen className="w-6 h-6 text-slate-400" />
              </div>
              <ChevronRight className="w-5 h-5 text-slate-400 opacity-0 group-hover:opacity-100 transition-all transform group-hover:translate-x-1" />
            </div>
        ...
        <div className="mt-12 p-4 bg-slate-800/40 rounded-xl border border-slate-700/50 inline-flex items-center gap-4 text-left mx-auto">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Ouvrez l'Assistant IA dans le menu pour des conseils personnalisés.</p>
          </div>
        </div>
