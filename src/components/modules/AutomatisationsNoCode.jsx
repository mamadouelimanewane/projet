  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {data.map(rule => (
          <div key={rule.id} className={`flex items-stretch border rounded-xl overflow-hidden transition-all shadow-md group ${rule.active ? "app-surface2 border-indigo-500/50 hover:border-indigo-400" : "app-surface app-border opacity-70 hover:opacity-100 disabled"}`}>
            {/* Toggle Column */}
            <div className="w-16 flex items-center justify-center border-r app-border app-surface">
            ...
            <div className="flex-1 p-5 flex flex-col md:flex-row gap-4 items-center">
              <div className="flex-1 min-w-0 w-full">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs font-mono font-medium">
                  <span className="app-surface3 app-text px-2 py-1 rounded">QUAND</span>
                  ...
                  <span className="app-text3">+</span>
                  <span className="app-surface3 app-text px-2 py-1 rounded">SI CONDITION</span>
                  ...
                  <span className="app-text3 ml-2">👉</span>
