  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-3 px-4 py-2.5 app-surface2 hover:app-surface3 backdrop-blur-sm border app-border rounded-xl transition-all group"
      >
        ...
        <ChevronDown className={`w-4 h-4 app-text2 transition-transform ${showProjectSelector ? 'rotate-180' : ''}`} />
      </button>
          ...
          <div className="absolute top-full right-0 mt-2 w-96 app-surface backdrop-blur-xl border app-border rounded-2xl shadow-2xl z-50 overflow-hidden">
            ...
            <div className="max-h-96 overflow-y-auto">
              <button
                ...
                className={`w-full text-left p-4 hover:app-surface2 transition-colors border-b app-border ${
              ...
              {filteredProjects.length === 0 ? (
                <div className="p-6 text-center app-text3">
                ...
                filteredProjects.map(projet => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-4 hover:app-surface2 transition-colors border-b app-border last:border-b-0 ${
                    ...
                    >
                      <div className="flex items-start gap-3 relative">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] app-text3 font-bold uppercase tracking-wider mb-2">
                            {projet.chef} • {projet.statut}
                          </p>

                          {/* Stats rapides */}
                          <div className="flex items-center gap-3 text-xs">
                            <span className="flex items-center gap-1 app-text2">
                          ...
                          {/* Barre avancement */}
                          <div className="mt-2 w-full app-surface2 rounded-full h-1 overflow-hidden">
                            <div
            ...
            {/* Footer */}
            <div className="p-3 border-t app-border app-surface2">
              <button
                onClick={() => {
                  setShowProjectSelector(false);
