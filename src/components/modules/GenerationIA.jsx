    ...
    <div className="space-y-8 animate-entrance max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h3 className="text-[10px] font-black app-text3 uppercase tracking-widest pl-2">Modèles de Rapports</h3>
          {[
            "Status Hebdomadaire", 
            ...
            <button key={r} onClick={() => setActiveReport(r)}
              className={`w-full text-left p-4 rounded-xl border transition-all ${activeReport === r ? "bg-indigo-600 border-indigo-500 text-white shadow-lg" : "app-surface2 app-border app-text2 hover:app-surface2"}`}>
        ...
        <div className="lg:col-span-3">
          <div ref={reportRef} className="app-surface border app-border p-12 rounded-2xl shadow-2xl space-y-10 min-h-[1000px]">
            {/* Report Header */}
            <div className="flex justify-between items-start border-b app-border pb-8">
              ...
              <div className="text-right">
                <p className="text-xs app-text3 font-mono">Date : {new Date().toLocaleDateString()}</p>
                <p className="text-xs app-text3 font-mono">ID : REP-2026-X45</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-indigo-500/5 border border-indigo-500/20 rounded-xl relative overflow-hidden">
                ...
                <p className="app-text text-sm leading-relaxed italic">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <h5 className="text-[10px] font-black app-text3 uppercase tracking-widest text-center">Répartition des Statuts</h5>
                  <div className="h-48">
                ...
                <div className="space-y-4">
                  <h5 className="text-[10px] font-black app-text3 uppercase tracking-widest text-center">Budget Consommé vs Prévu</h5>
                  <div className="h-48">
                    <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="space-y-4">
                <h5 className="text-[10px] font-black app-text3 uppercase tracking-widest">Détail du Portefeuille Actif</h5>
                <div className="app-bg border app-border rounded-xl overflow-hidden">
                  <div className="overflow-x-auto -mx-1">
                  <table className="w-full text-left text-xs">
                    <thead className="app-surface2 app-text3 uppercase font-black tracking-tighter">
                      <tr>
