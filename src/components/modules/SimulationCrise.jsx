  ...
  return (
    <div className="space-y-6">
      <SectionHeader 
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm app-text">Niveau de Stress : {data.stressLevel || 12}%</span>
          </div>
        }
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {scenarios.map(s => (
          <Card key={s.id} className={`p-6 glass-card rounded-2xl border-2 transition-all ${activeScenario === s.id ? 'border-indigo-500 bg-indigo-500/10' : 'app-border'}`}>
           ...
           <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="text-center md:text-left space-y-2">
                 ...
                 <div className="pt-4 flex gap-4">
                    <div className="p-4 app-surface rounded-xl border app-border">
                       <p className="text-[10px] app-text3 font-bold uppercase mb-1">Capacité de Survie</p>
                       <p className="text-2xl font-black text-red-500">22%</p>
                    </div>
                    <div className="p-4 app-surface rounded-xl border app-border">
                       <p className="text-[10px] app-text3 font-bold uppercase mb-1">Délai avant Faillite</p>
              ...
              <div className="flex-1 w-full space-y-6">
                 ...
                 <div className="p-4 bg-red-600/10 rounded-xl border border-red-500/20">
                    ...
                    <ul className="text-xs app-text space-y-2">
