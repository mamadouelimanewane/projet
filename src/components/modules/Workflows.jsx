...
const Workflows = ({ data = [], setData }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {data.length === 0 ? (
        <div className="text-center p-8 text-slate-500 glass-card rounded-2xl">
          ...
          {data.map(w => (
            <div key={w.id} className="bg-slate-800/60 border border-slate-700/50 rounded-xl p-4 flex justify-between items-center hover:border-indigo-500/40">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-10 h-6 bg-slate-700 rounded-full relative cursor-pointer" onClick={() => toggleStatut(w.id)}>
